...
from include.stock_market.tasks import (
    _get_stock_prices, _store_prices, _get_formatted_csv
)
...
@dag(
    ...
    schedule='@daily',
    catchup=False,
    tags=['fetching_formatted_prices_from_minio'],
)
def fetching_formatted_prices_from_minio():
    ...
    # tylko dekoratory musza byc wywolywane w DAGU. dlatego nie ma wywolania get_stock_prices a jest is_api_available
    is_api_available() >> get_stock_prices >> store_prices >> format_prices >> get_formatted_csv
    

fetching_formatted_prices_from_minio()
